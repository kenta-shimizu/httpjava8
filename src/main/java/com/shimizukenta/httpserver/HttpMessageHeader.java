...
public class HttpMessageHeader {
	...
	public static HttpMessageHeader nowDate() {
		return HttpMessageHeader.create(HttpMessageHeaderField.Date, nowZdt());
	}
	
	public static HttpMessageHeader nowLastModified() {
		return HttpMessageHeader.create(HttpMessageHeaderField.LastModified, nowZdt());
	}
